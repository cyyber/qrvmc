...
struct Output
{
    ...
    explicit Output(const char* output_hex) noexcept : bytes{qrvmc::from_hex(output_hex).value()} {}
...
{
protected:
    qrvmc_revision rev = QRVMC_MAX_REVISION;
    qrvmc::MockedHost host;
    qrvmc_message msg{};

    example_vm() noexcept
    {
        msg.sender = "Q000000000000000000000000000000000000000000000000000000005000000000000000000000000000000000000005"_address;
        msg.recipient = "Q00000000000000000000000000000000000000000000000000000000d00000000000000000000000000000000000000d"_address;
    }
