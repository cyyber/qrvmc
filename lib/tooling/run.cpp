...
constexpr auto create_address = "Q00000000000000000000000000000000000000000000000000000000c9ea7ed000000000000000000000000000000001"_address;
...
auto bench(MockedHost& host,
           ...
           bytes_view code,
           const qrvmc::Result& expected_result,
           std::ostream& out)
{
    {
        ...
        std::ostream& out)
{
    ...
    if (create)
    {
        qrvmc_message create_msg{};
        create_msg.kind = QRVMC_CREATE;
        ...
        if (create_result.status_code != QRVMC_SUCCESS)
        {
