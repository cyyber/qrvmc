...
enum
{
     ...
     * in practice in QRVM implementations.
     */
    UNDEFINED = ZERO
};
...
static const struct qrvmc_instruction_metrics zond_metrics[256] = {
    ...
    /*         PUSH33 = 0x80 */ {VERYLOW, 0, 1},
    /*         PUSH34 = 0x81 */ {VERYLOW, 0, 1},
    /*         PUSH35 = 0x82 */ {VERYLOW, 0, 1},
    /*         PUSH36 = 0x83 */ {VERYLOW, 0, 1},
    /*         PUSH37 = 0x84 */ {VERYLOW, 0, 1},
    /*         PUSH38 = 0x85 */ {VERYLOW, 0, 1},
    /*         PUSH39 = 0x86 */ {VERYLOW, 0, 1},
    /*         PUSH40 = 0x87 */ {VERYLOW, 0, 1},
    /*         PUSH41 = 0x88 */ {VERYLOW, 0, 1},
    /*         PUSH42 = 0x89 */ {VERYLOW, 0, 1},
    /*         PUSH43 = 0x8a */ {VERYLOW, 0, 1},
    /*         PUSH44 = 0x8b */ {VERYLOW, 0, 1},
    /*         PUSH45 = 0x8c */ {VERYLOW, 0, 1},
    /*         PUSH46 = 0x8d */ {VERYLOW, 0, 1},
    /*         PUSH47 = 0x8e */ {VERYLOW, 0, 1},
    /*         PUSH48 = 0x8f */ {VERYLOW, 0, 1},
    /*         PUSH49 = 0x90 */ {VERYLOW, 0, 1},
    /*         PUSH50 = 0x91 */ {VERYLOW, 0, 1},
    /*         PUSH51 = 0x92 */ {VERYLOW, 0, 1},
    /*         PUSH52 = 0x93 */ {VERYLOW, 0, 1},
    /*         PUSH53 = 0x94 */ {VERYLOW, 0, 1},
    /*         PUSH54 = 0x95 */ {VERYLOW, 0, 1},
    /*         PUSH55 = 0x96 */ {VERYLOW, 0, 1},
    /*         PUSH56 = 0x97 */ {VERYLOW, 0, 1},
    /*         PUSH57 = 0x98 */ {VERYLOW, 0, 1},
    /*         PUSH58 = 0x99 */ {VERYLOW, 0, 1},
    /*         PUSH59 = 0x9a */ {VERYLOW, 0, 1},
    /*         PUSH60 = 0x9b */ {VERYLOW, 0, 1},
    /*         PUSH61 = 0x9c */ {VERYLOW, 0, 1},
    /*         PUSH62 = 0x9d */ {VERYLOW, 0, 1},
    /*         PUSH63 = 0x9e */ {VERYLOW, 0, 1},
    /*         PUSH64 = 0x9f */ {VERYLOW, 0, 1},
    /*           DUP1 = 0xa0 */ {VERYLOW, 1, 1},
    /*           DUP2 = 0xa1 */ {VERYLOW, 2, 1},
    /*           DUP3 = 0xa2 */ {VERYLOW, 3, 1},
    /*           DUP4 = 0xa3 */ {VERYLOW, 4, 1},
    /*           DUP5 = 0xa4 */ {VERYLOW, 5, 1},
    /*           DUP6 = 0xa5 */ {VERYLOW, 6, 1},
    /*           DUP7 = 0xa6 */ {VERYLOW, 7, 1},
    /*           DUP8 = 0xa7 */ {VERYLOW, 8, 1},
    /*           DUP9 = 0xa8 */ {VERYLOW, 9, 1},
    /*          DUP10 = 0xa9 */ {VERYLOW, 10, 1},
    /*          DUP11 = 0xaa */ {VERYLOW, 11, 1},
    /*          DUP12 = 0xab */ {VERYLOW, 12, 1},
    /*          DUP13 = 0xac */ {VERYLOW, 13, 1},
    /*          DUP14 = 0xad */ {VERYLOW, 14, 1},
    /*          DUP15 = 0xae */ {VERYLOW, 15, 1},
    /*          DUP16 = 0xaf */ {VERYLOW, 16, 1},
    /*          SWAP1 = 0xb0 */ {VERYLOW, 2, 0},
    /*          SWAP2 = 0xb1 */ {VERYLOW, 3, 0},
    /*          SWAP3 = 0xb2 */ {VERYLOW, 4, 0},
    /*          SWAP4 = 0xb3 */ {VERYLOW, 5, 0},
    /*          SWAP5 = 0xb4 */ {VERYLOW, 6, 0},
    /*          SWAP6 = 0xb5 */ {VERYLOW, 7, 0},
    /*          SWAP7 = 0xb6 */ {VERYLOW, 8, 0},
    /*          SWAP8 = 0xb7 */ {VERYLOW, 9, 0},
    /*          SWAP9 = 0xb8 */ {VERYLOW, 10, 0},
    /*         SWAP10 = 0xb9 */ {VERYLOW, 11, 0},
    /*         SWAP11 = 0xba */ {VERYLOW, 12, 0},
    /*         SWAP12 = 0xbb */ {VERYLOW, 13, 0},
    /*         SWAP13 = 0xbc */ {VERYLOW, 14, 0},
    /*         SWAP14 = 0xbd */ {VERYLOW, 15, 0},
    /*         SWAP15 = 0xbe */ {VERYLOW, 16, 0},
    /*         SWAP16 = 0xbf */ {VERYLOW, 17, 0},
    /*           LOG0 = 0xc0 */ {1 * 375, 2, -2},
    /*           LOG1 = 0xc1 */ {2 * 375, 3, -3},
    /*           LOG2 = 0xc2 */ {3 * 375, 4, -4},
    /*           LOG3 = 0xc3 */ {4 * 375, 5, -5},
